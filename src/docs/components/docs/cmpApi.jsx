			...
			<div className={style.api}>
				...
				<div className={style.functionSection}>
					...
					<span className={style.argument}>
						<span className={style.argumentType}>command (String)</span>:{' '}
						<span>Name of the command to execute</span>
					</span>
					<span className={style.argument}>
						<span className={style.argumentType}>[parameter] (*)</span>:{' '}
						<span>Parameter to be passed to the command function</span>
					</span>
					<span className={style.argument}>
						<span className={style.argumentType}>[callback] (Function)</span>:{' '}
						<span>Function to be executed with the result of the command</span>
					</span>
				</div>
				...
				<div className={style.commands}>
					{commands.map(({ command, parameter, callback }) => (
						<div className={style.functionSection}>
							...
							<span className={style.argument}>
								<span className={style.argumentType}>command</span>:{' '}
								<span>"{command}"</span>
							</span>
							<span className={style.argument}>
								<span className={style.argumentType}>{parameter.type}</span>:{' '}
								<span>{parameter.description}</span>
							</span>
							<span className={style.argument}>
								<span className={style.argumentType}>[callback(result)]</span>:{' '}
								<span>
							...
							<div className={style.commandArguments}>
								<span className={style.functionSectionTitle}>Arguments</span>
								<span className={style.argument}>
									<span className={style.argumentType}>
										{callback.resultType}
									</span>
									: <span>{callback.resultDescription}</span>
								</span>
							</div>
						</div>
					))}
