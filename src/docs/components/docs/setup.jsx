	...
	render(props, state) {
		...
		return (
			<div>
				...
				<p>
					The consent tool script should be added to the header of your page.
					All commands can be be called immediately after the script include.
					When the full implementation is loaded any queued commands will be
					executed in the order they were received.
				</p>
				<div class={style.bookmarklet}>
					Run this on any site by creating a bookmark of{' '}
