			...
			<div class={style.vendorListBuilder}>
				<div class={style.controls}>
					...
					<div class={style.generate}>
						<button class={style.button} onClick={this.generateList}>
							Generate List
						</button>
					</div>
				</div>
						...
						<thead>
							<tr>
								...
								<th class={style.include}>
									<a onClick={this.handleSelectAllPurposes(true)}>All</a> /{' '}
									<a onClick={this.handleSelectAllPurposes(false)}>None</a>
								</th>
							</tr>
						</thead>
						<tbody>
					...
					<table>
						<thead>
							<tr>
								...
								<th>Name</th>
								<th class={style.include}>
									<a onClick={this.handleSelectAllVendors(true)}>All</a> /{' '}
									<a onClick={this.handleSelectAllVendors(false)}>None</a>
								</th>
							</tr>
						</thead>
						<tbody>
