	...
	render(props, state) {
		...
		return (
			<div className={style.example}>
				<div className={style.exampleName}>{title}</div>
				<div className={style.exampleSections}>
					{setup && (
						<div className={style.exampleSection}>
							<span className={style.exampleLabel}>Setup</span>
							<CodeMirror
					...
					{execute && (
						<div className={style.exampleSection}>
							<span className={style.exampleLabel}>
								Code
								<button className={style.execute} onClick={this.execute}>
									Execute
								</button>
							</span>
							<CodeMirror
					...
					<div className={style.exampleSection}>
						<span className={style.exampleLabel}>
							My Logger Output
							<button className={style.execute} onClick={this.clearLog}>
								Clear
							</button>
						</span>
