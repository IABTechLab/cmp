					...
					<LocalLabel
						providedValue={
							localization && localization.purposes
								? localization.purposes.disclaimer
								: ''
						}
						localizeKey="disclaimer"
					>
						We and selected companies may access and use information for the
						purposes outlined. You may customise your choice or continue using
						our site if you are OK with the purposes. You can see the{' '}
					</LocalLabel>
					<a class={style.vendorLink} onClick={onShowVendors}>
						<LocalLabel
							providedValue={
								localization && localization.purposes
									? localization.purposes.disclaimerVendorLink
									: ''
							}
							localizeKey="disclaimerVendorLink"
						>
							complete list of companies here.
						</LocalLabel>
					</a>
				</div>
					...
					<div class={style.purposeList}>
						{allPurposes.map((purpose, index) => (
							...
							>
								<LocalLabel
									localizeKey={`${
										index >= purposes.length ? 'customPurpose' : 'purpose'
									}${purpose.id}.menu`}
								>
									{purpose.name}
								</LocalLabel>
						...
						>
							<div class={style.purposeDetail + ' primaryText'}>
								...
								<div class={style.body}>
									...
									{!showLocalVendors && (
										<a
											class={style.vendorLink}
											onClick={this.onShowLocalVendors}
										>
											<LocalLabel
												providedValue={
													localization && localization.purposes
									...
									{showLocalVendors && (
										<a
											class={style.vendorLink}
											onClick={this.onHideLocalVendors}
										>
											<LocalLabel
												providedValue={
													localization && localization.purposes
